...
describe('CostTrackingContext', () => {
  ...
  describe('trackToolCost', () => {
    it('should track tool execution and update costs', () => {
      ...
      expect(result.current.executions[0].toolId).toBe('drug-checker');
    });
    ...
    it('should categorize costs correctly', () => {
      ...
      const categoryCosts = result.current.categoryCosts;
      expect(categoryCosts['Medication Management']).toBeGreaterThan(0);
    });
  });
  ...
  describe('getROIMetrics', () => {
    it('should calculate ROI metrics correctly', () => {
      ...
      expect(roi.valueCreated).toBeGreaterThan(0);
    ...
    it('should calculate positive ROI when value exceeds cost', () => {
      ...
      expect(roi.netValue).toBeGreaterThan(0);
    });
  });
  ...
  describe('resetCostData', () => {
    it('should clear all cost tracking data', () => {
      ...
      expect(result.current.monthlyCost).toBe(0);
    });
  ...
  describe('persistence', () => {
    ...
    it('should load persisted data on mount', () => {
      ...
      const initialData = {
        ...
        categoryCosts: { 'Medication Management': 0.05 },
        costLimit: 100
      };
      ...
      expect(result.current.totalCost).toBe(1.5);
      expect(result.current.executions).toHaveLength(1);
    });
  });
});
